...
This project includes a preprocessed dataset (data.pickle) containing hand landmark features and labels extracted from our generated sign language images. The full raw image dataset used to generate this file is not included in the repository due to size constraints. 
